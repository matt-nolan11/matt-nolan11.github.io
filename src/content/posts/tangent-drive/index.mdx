...
<ModularSection columns={[
  {
    type: 'image',
    src: z3phyrImage,
    alt: 'Z3phyr (right) with asymmetric front/back wheel sizes, fighting spinny boiii (left) at RCL Nationals 2025.',
    caption: 'Z3phyr (right) with asymmetric front/back wheel sizes, fighting spinny boiii (left) at RCL Nationals 2025 (Credit: Mark Liu)'
  }
]} />
