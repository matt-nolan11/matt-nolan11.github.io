...
<ModularSection
  columns={[
      ...
      items: [
        {
          ...
          summaryDescription: "The first prototype of the Smart RC Power Meter, using a collection of COTS development boards and a 3D printed case",
          startDate: "2025-06",
          endDate: "2025-11",
          status: "completed",
          headerTitleSize: "lg",
    ...
    },
    {
      ...
      width: 50,
      gallery: [
        { src: withCaseImage, caption: "Prototype 1 with its 3D printed case" },
